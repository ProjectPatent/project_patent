...
class MetricError(MonitoringError):
    ...
    def __init__(self, message: str, metric_name: str = None, **context):
...
class ValidationError(MonitoringError):
    ...
    def __init__(self, message: str, field_name: str, invalid_value: Any, validation_rule: str):
        super().__init__(message, field_name=field_name, invalid_value=invalid_value, validation_rule=validation_rule)

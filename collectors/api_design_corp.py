...
class AsyncDesignDownloaderCorp:
    def __init__(self):
    ...
    async def process_all(self):
        ...
        try:
            ...
            output_path = f'data/{date_str}_design_corp.xml'
            ...
            date_str = datetime.now().strftime('%Y%m%d')
            output_path = f'data/{date_str}_design_corp_interrupted.xml'
            self.xml_builder.save(output_path)
